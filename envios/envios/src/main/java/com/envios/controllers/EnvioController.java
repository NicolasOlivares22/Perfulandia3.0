...
//Metodos hateoas
    ...
    public EnvioDTO obtenerHATEOAS(@PathVariable Integer id) {
        ...
        String proxyUrl = "http://localhost:8084/api/proxy/envios/" + dto.getIdEnvio();
    ...
    public ResponseEntity<List<EnvioDTO>> obtenerTodosHATEOAS() {
        ...
        lista.forEach(dto -> {
            ...
            dto.add(Link.of("http://localhost:8084/api/proxy/envios")
                        .withRel("Get todos HATEOAS"));
            dto.add(Link.of("http://localhost:8084/api/proxy/envios/" + dto.getIdEnvio())
